...
const galleries: Record<string, Gallery> = {
  "project-1": {
    ...
    images: [
      "/projects/other-works/project-1/1.webp",
      "/projects/other-works/project-1/2.webp",
      "/projects/other-works/project-1/3.webp",
      "/projects/other-works/project-1/4.webp",
      "/projects/other-works/project-1/5.webp",
      "/projects/other-works/project-1/6.webp",
      "/projects/other-works/project-1/7.webp",
    ],
  },
  "project-2": {
    no: "05.2",
...
通过传统美学、现代设计与本地 AI 技术的结合，联想 AI 画师探索了一种更加安全、高效且具有文化表达力的 AI 创作方式。`,
    images: [
      "/projects/other-works/project-2/1.webp",
      "/projects/other-works/project-2/2.webp",
      "/projects/other-works/project-2/3.webp",
      "/projects/other-works/project-2/4.webp",
      "/projects/other-works/project-2/5.webp",
      "/projects/other-works/project-2/6.webp",
    ],
  },
  "project-3": {
    no: "05.3",
    ...
    images: [
      "/projects/other-works/project-3/01.webp",
      "/projects/other-works/project-3/02.webp",
      "/projects/other-works/project-3/03.webp",
      "/projects/other-works/project-3/04.webp",
      "/projects/other-works/project-3/05.webp",
      "/projects/other-works/project-3/06.webp",
    ],
  },
  "project-4": {
    no: "05.4",
...
项目设计聚焦复杂 AI 系统中的信息组织、数据决策与操作效率，通过清晰的信息架构、数据可视化和模块化设计降低使用门槛。同时建立统一的设计语言与 Design System，让复杂的 AI 能力以更直观、一致且易于管理的方式呈现。`,
    images: [
      "/projects/other-works/project-4/cover.webp",
      "/projects/other-works/project-4/1.webp",
      "/projects/other-works/project-4/2.webp",
      "/projects/other-works/project-4/3.webp",
      "/projects/other-works/project-4/4.webp",
      "/projects/other-works/project-4/5.webp",
      "/projects/other-works/project-4/6.webp",
    ],
  },
};
